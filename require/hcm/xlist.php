...
{
    list($GLOBALS['__hcm_uid'], $rdirs, $item, $item_noext, $counter, $count, $end) = $GLOBALS['_hcm_xlist_data'];
...
function _HCM_xlist($adresar = "", $maska_souboru = "", $razeni = 0, $strankovani = 0, $maska = "", $zobrazeni_strankovani = null, $kod_pred = null, $kod_za = null)
{
    ...
    if($rpaging != false) {
        $rcover_top = "<div class='anchor'><a name='hcm_xlist".$GLOBALS['__hcm_uid']."'></a></div>\n".$rcover_top;
    }
    ...
    if($rhandle) {
        ...
        if($rpaging != false) {
            $rpaging_data = _resultPaging(_indexOutput_url, $rpaging, $count, "", "#hcm_xlist".$GLOBALS['__hcm_uid'], "hcm_xlist".$GLOBALS['__hcm_uid']."p");
        }
        ...
        foreach($ritems as $item) {
            ...
            $GLOBALS['_hcm_xlist_data'] = array($GLOBALS['__hcm_uid'], $rdirs, $item, $item_noext, $counter, $count, $end);
