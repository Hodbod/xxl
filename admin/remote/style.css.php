...
$scheme_lightest=_hsb2rgb($scheme, 40, $scheme_brightness+25);
...
/* tagy  <style>/**/
* {margin: 0; padding: 0;}
body {font-family: sans-serif; font-size: 12px; color: #<?php echo $text; ?>; background-color: #ffffff; margin: 0;}
...
/* hlavicka */
#header {font-family: Georgia, "Times New Roman", Times, serif; font-size: 24px; color: #<?php echo $scheme_contrast; ?>; background: #<?php echo $scheme; ?> url(../images/sh_header.png) left bottom repeat-x; padding: 10px; border-bottom: 1px solid #<?php echo $scheme_dark; ?>;}
...
/* menu */
#menu {background-color: #<?php echo $scheme_lighter; ?>; color: #<?php echo $scheme_contrast; ?>; border-bottom: 1px solid #<?php echo $smoke; ?>;}
...
/* obsah */
#content {padding: 12px 16px 16px 16px; border-bottom: 1px solid #<?php echo $smoke_gray; ?>; min-width: 800px;}

/* copyright */
#copyright {text-align: right; padding: 5px 8px; background-color: #<?php echo $scheme; ?>; border-bottom: 1px solid #<?php echo $smoke_gray; ?>;}
...
#external-container h1 {border-bottom: 3px solid #<?php echo $scheme; ?>; padding-bottom: 3px; margin-bottom: 6px;}
  ...
  #indextable td {padding: 10px; border: 1px solid #<?php echo $smoke_gray; ?>; background-color: #<?php echo $smoke; ?>;}
  #indextable h2 {margin-bottom: 6px; border-bottom: 1px solid #<?php echo $smoke_gray; ?>; padding-bottom: 6px;}
  #indextable li {padding: 3px;}
  #news-box h2 {font-size: 18px; border-bottom: 1px solid #<?php echo $smoke_gray; ?>; margin-bottom: 12px; padding-bottom: 6px;}
  #news h3 {font-size: 16px; color: #<?php echo $link; ?>;}
  #news p {margin-bottom: 3px;}
  #news div {margin-bottom: 15px; color: #<?php echo $smoke_text; ?>;}

  /* sprava obsahu */
  #contenttable {width: 100%; border: 1px solid #<?php echo $smoke_gray; ?>; line-height: 140%;}
  #contenttable a {text-decoration: none;}
  #contenttable h2 {margin: 0 0 8px 0; padding: 4px 0 7px 0; border-bottom: 1px solid #<?php echo $smoke_gray; ?>;}
  #contenttable div.pad {padding: 20px 0;}
  .contenttable-box {padding: 8px; margin: 0; border-right: 1px solid #<?php echo $smoke_gray; ?>;}
  ...
  #boxesedit td.cell div {border: 1px solid #<?php echo $smoke_gray; ?>; padding: 20px 15px;}
  
  /* souborovy manazer */
  #fman-action {border-bottom: 1px solid #<?php echo $smoke_gray; ?>; margin-bottom: 10px;}
  ...
  .fman-menu {border-width: 1px 0 1px 0; border-style: solid; border-color: #<?php echo $smoke_gray; ?>;}
  .fman-menu, .fman-menu2 {margin-top: 5px; padding: 5px;}
  .fman-menu a, .fman-menu span, .fman-menu2 a, .fman-menu2 span {border-right: 1px solid #<?php echo $smoke_gray; ?>; padding-right: 8px; margin-right: 8px;}
  ...
  #gallery-browser #gallery-browser-actdir {padding-bottom: 3px; margin-bottom: 2px; border-bottom: 1px solid #<?php echo $smoke_gray; ?>;}
  ...
  .gallery-edittable-td a {color: #000;}
  #gallery-edittable a.lightbox img {border: 1px solid #<?php echo $smoke_text; ?>;}
...
.message1, .message2, .message3 {margin: 5px 0 20px 0; padding: 13px 5px 13px 48px; border: 1px solid #<?php echo $smoke_gray; ?>; font-weight: bold; background-color: #<?php echo $smoke; ?>; background-position: 5px 5px; background-repeat: no-repeat;}
...
.wintable, .listable {border: 1px solid #<?php echo $smoke_gray; ?>;}
.wintable {width: 100%;}
...
.wintable td.rbor, .listable td.rbor {border-right: 1px solid #<?php echo $smoke_gray; ?>;}
.wintable h2, .listable h2 {margin-bottom: 10px; padding-bottom: 5px; border-bottom: 1px solid #<?php echo $smoke_gray; ?>;}
.listable thead td {font-weight: bold;}

.list {border-collapse: collapse;}
.list thead td {font-weight: bold; background-color: #<?php echo $smoke; ?>;}
.list td {padding: 5px 32px 5px 5px; border: 1px solid #<?php echo $smoke_gray; ?>;}
...
.bborder {padding-bottom: 8px; margin-bottom: 12px; border-bottom: 1px solid #<?php echo $smoke_gray; ?>;}
fieldset .bborder {border-color: #<?php echo $smoke_text; ?>;}
.customsettings {border-left: 1px solid #<?php echo $smoke_gray; ?>; padding-left: 8px;}
